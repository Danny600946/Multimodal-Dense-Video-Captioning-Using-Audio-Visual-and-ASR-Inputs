...
# Description: A file to manage script arguments for passing data into files dynamically.
# Changes include: Added arguments concerning audio data.
# License: MIT
...
def get_args_parser():
    ...
    # Added audio arguments
    parser.add_argument('--audio_features_train_path', type=str, default=None, help="Path to TRAIN audio features (.pt files)")
    parser.add_argument('--audio_features_val_path', type=str, default=None, help="Path to VAL audio features (.pt files)")

    parser.add_argument(
        "--noise_density",
        default=0.25,
        type=float,
        help="Noise density for span masking (default 0.25)",
    )
    parser.add_argument(
        "--mean_noise_span_length",
        default=5,
        type=int,
        help="Average length of masked spans (default 5)",
    )   

    parser.add_argument("--use_audio_features", action="store_true", help="Use audio features during training.")
